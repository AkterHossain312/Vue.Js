...
<script>
//import variables from '../router/variables';
...
methods:{
    ...
    createClick(){
        axios.post("http://localhost:49146/api/"+"department",{
    ...
    updateClick(){
        axios.put("http://localhost:49146/api/"+"department",{
    ...
    deleteClick(id){
        ...
        axios.delete("http://localhost:49146/api/"+"department/"+id)
        .then((response)=>{
            this.refreshData();
            alert(response.data);
        });
