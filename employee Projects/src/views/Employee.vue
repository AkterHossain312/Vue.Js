...
methods:{
    refreshData(){
        axios.get("http://localhost:49146/api/"+"employee")
        .then((response)=>{
            this.employees=response.data;
        });

        axios.get("http://localhost:49146/api/"+"department")
        .then((response)=>{
    ...
    createClick(){
        axios.post("http://localhost:49146/api/"+"employee",{
    ...
    updateClick(){
        axios.put("http://localhost:49146/api/"+"employee",{
    ...
    deleteClick(id){
        ...
        axios.delete("http://localhost:49146/api/"+"employee/"+id)
        .then((response)=>{
            this.refreshData();
            alert(response.data);
        });
    ...
    imageUpload(event){
        ...
        axios.post(
            "http://localhost:49146/api/"+"employee/savefile",
            formData)
            .then((response)=>{
